    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4">
      <div className="flex flex-col md:flex-row bg-white shadow-xl rounded-2xl overflow-hidden w-full max-w-4xl">
        ...
        <div className="w-full md:w-1/2 p-10">
          <h2 className="text-3xl font-bold text-center text-violet-900 mb-6">Login to Your Account</h2>
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-violet-800 mb-1">Password</label>
              <input
                type="password"
          ...
          {msg && <p className="text-red-600 mt-4 text-center text-sm">{msg}</p>}
        </div>
      </div>
    </div>
  );
